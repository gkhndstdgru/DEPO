...
namespace ArızaTakipFinal
{
    public partial class Form4 : Form
    {
        ...
        {
            DialogResult cevap;
            cevap = MessageBox.Show("Ekipten Çıkartmak İstiyormusunuz ", "Uyarı!!", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
            if (cevap == DialogResult.Yes)
            {
                SqlConnection baglanti = new SqlConnection("Data source=DOSTDOGRU\\SQLEXPRESS; Initial Catalog=ArızaTakip2; Integrated Security=true;");
                if (dataGridView2.CurrentRow.Cells[3].Value.ToString()=="Merkez1")
                {
                    baglanti.Open();
                ...
                else if (dataGridView2.CurrentRow.Cells[3].Value.ToString()=="Merkez2")
                {
                    baglanti.Open();
                ...
                else if (dataGridView2.CurrentRow.Cells[3].Value.ToString()=="Merkez3")
                {
                    baglanti.Open();
                ...
                else if (dataGridView2.CurrentRow.Cells[3].Value.ToString()=="Merkez4")
                {
                    baglanti.Open();
                ...
                else if (dataGridView2.CurrentRow.Cells[3].Value.ToString()=="Merkez5")
                {
                    baglanti.Open();
