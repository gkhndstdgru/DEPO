    ...
    public partial class Form7 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.CommandText = "IslemEkle";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.AddWithValue("@YeniAciklama",textBox1.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            DataTable tablo = new DataTable();
            tablo.Clear();
            SqlDataAdapter adtr = new SqlDataAdapter("Select A.ArızaNo,A.Tarih,A.Adres,A.Sikayet,T.TalepciAd,T.TalepciSoyad,E.EkipAd from Arıza A ,ArızaTalep T,ArızaArızaTalep AT,ArızaEkip AE,Ekip E where A.ArızaNo=AT.ArızaNo and T.TalepNo=AT.TalepNo and E.EkipNo=AE.EkipNo and A.ArızaNo=AE.ArızaNo and  A.Tarih='" + dateTimePicker2.Value.ToShortDateString() + "' ", baglanti);
            adtr.Fill(tablo);
            dataGridView1.DataSource = tablo; 
